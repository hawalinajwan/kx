...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center  bg-gray-950">
      ...
      <div className="z-10 max-w-5xl space-x-16 items-center justify-between font-mono lg:grid-cols-2 text-sm lg:flex lg:inset-0">

        <Image
          className="relative scroll-smooth lg:inset-0 lg:object-center"
          src="/images/Ak (2).png"
          alt="kxm Logo"
          width={400}
          height={400}
        ...
        <a
          ...
          className="group rounded-lg border border-transparent py-5 px-2  transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
          target="_blank"
